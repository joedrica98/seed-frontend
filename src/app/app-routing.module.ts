...
const routes: Routes = [
  { path:'auth', loadChildren: () => import('./views/pages/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
      {
        path: 'inversionista',
        loadChildren: () => import('./views/pages/inversionista/inversionista.module').then(m => m.InversionistaModule)
      },
      {
        path: 'cliente',
        loadChildren: () => import('./views/pages/cliente/cliente.module').then(m => m.ClientesModule)
      },
      {
        path: 'gastos',
        loadChildren: () => import('./views/pages/gastos/gastos.module').then(m => m.GastosModule)
      },
      {
        path: 'movimientos',
        loadChildren: () => import('./views/pages/movimientos/movimientos.module').then(m => m.MovimientosModule)
      },
      {
        path: 'dashboard',
